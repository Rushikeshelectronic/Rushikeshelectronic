...
<!-- SVG for the invalid icon of password -->
                            <div class="invalid-pass" style='display:none;'>
                                <span class="invalid-icon">
                                    <svg fill="#d93025" focusable="false" width="16px" height="16px" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg">
                                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z"></path>
                                    </svg>
                                </span><span class='invalid-email-text-span'>Wrong password. Try again or Click Forget password to reset it.</span>
     </div>
                   <legend class='g-legend'>Forgot Password?</legend>
                            ...
                            <div class='login-nav'>
                               ...
                               <!--<button name="btn" id="btn" class='gbtn-primary' type="submit">Next1</button> -->
                            </div>
                        </div>
                    </form>
                </div>
